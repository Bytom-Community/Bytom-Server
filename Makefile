...
sdk:
	@echo "Building golang sdk to sdk dir"
	@mkdir -p sdk/go_bytom
	protoc -I/usr/local/include -I. \
	-I$(GOPATH)/src \
	-I$(GOPATH)/src/github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis \
	--go_out=plugins=grpc:./sdk/go_bytom \
	./rpc/pb/*.proto
	...
	@echo "Building java sdk to sdk dir"
	@mkdir -p sdk/java_bytom
	protoc -I/usr/local/include -I. \
	-I${GOPATH}/src \
	-I${GOPATH}/src/github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis \
	...
	@echo "Building android sdk to sdk dir"
	@mkdir -p sdk/android_bytom
	protoc -I/usr/local/include -I. \
	-I${GOPATH}/src \
	-I${GOPATH}/src/github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis \
	--plugin=protoc-gen-grpc-java=${GOPATH}/src/github.com/grpc/grpc-java/compiler/build/exe/java_plugin/protoc-gen-grpc-java \
